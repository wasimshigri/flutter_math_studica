...
class SelectableMath extends StatelessWidget {
  ...
  /// {@macro flutter_math_studica.widgets.math.mathStyle}
  final MathStyle mathStyle;

  /// {@macro flutter_math_studica.widgets.math.logicalPpi}
  final double? logicalPpi;

  /// {@macro flutter_math_studica.widgets.math.onErrorFallback}
  final OnErrorFallback onErrorFallback;

  /// {@macro flutter_math_studica.widgets.math.options}
  final MathOptions? options;

  /// {@macro flutter_math_studica.widgets.math.parseError}
  ...
  ///
  /// {@macro flutter_math_studica.widgets.math.tex_builder}
  ///
  /// See alse:
  ///
