...
Future<void> loadKaTeXFonts() async {
  ...
  final katexMainLoader = FontLoader('packages/flutter_math_studica/KaTeX_Main')
  ...
  final katexMathLoader = FontLoader('packages/flutter_math_studica/KaTeX_Math')
  ...
  final katexAMSLoader = FontLoader('packages/flutter_math_studica/KaTeX_AMS')
    ..addFont(getFontData('lib/katex_fonts/fonts/KaTeX_AMS-Regular.ttf'));

  final katexCaligraphicLoader = FontLoader(
      'packages/flutter_math_studica/KaTeX_Caligraphic')
    ..addFont(
  ...
  final katexFrakturLoader = FontLoader(
      'packages/flutter_math_studica/KaTeX_Fraktur')
  ...
  final katexSansSerifLoader = FontLoader(
      'packages/flutter_math_studica/KaTeX_SansSerif')
  ...
  final katexScriptLoader = FontLoader(
      'packages/flutter_math_studica/KaTeX_Script')
    ..addFont(getFontData('lib/katex_fonts/fonts/KaTeX_Script-Regular.ttf'));

  final katexTypewriterLoader =
      FontLoader('packages/flutter_math_studica/KaTeX_Typewriter')
        ..addFont(
            getFontData('lib/katex_fonts/fonts/KaTeX_Typewriter-Regular.ttf'));

  final katexSize1Loader = FontLoader('packages/flutter_math_studica/KaTeX_Size1')
    ..addFont(getFontData('lib/katex_fonts/fonts/KaTeX_Size1-Regular.ttf'));

  final katexSize2Loader = FontLoader('packages/flutter_math_studica/KaTeX_Size2')
    ..addFont(getFontData('lib/katex_fonts/fonts/KaTeX_Size2-Regular.ttf'));

  final katexSize3Loader = FontLoader('packages/flutter_math_studica/KaTeX_Size3')
    ..addFont(getFontData('lib/katex_fonts/fonts/KaTeX_Size3-Regular.ttf'));

  final katexSize4Loader = FontLoader('packages/flutter_math_studica/KaTeX_Size4')
